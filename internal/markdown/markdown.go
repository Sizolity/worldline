// Package markdown is a small, domain-neutral markdown/frontmatter parser.
// It understands a deliberately narrow convention (YAML frontmatter, a
// single optional H1, a lead paragraph, and flat H2 sections) and carries
// no RPG/mod knowledge, so any package can reuse it as a leaf dependency.
package markdown
...
// Document is the parsed in-memory representation of a single markdown
// file. It uses a deliberately narrow markdown convention:
//
